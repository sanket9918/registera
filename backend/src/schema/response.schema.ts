...
import { getModelForClass, index, modelOptions, pre, prop as Property, Ref } from '@typegoose/typegoose';
...
export class Response {
  ...
  @Field(() => String)
  @Property({ required: true, default: () => `res_${nanoid()}`, unique: true })
  resId: string;
...
export const ResponseModel = getModelForClass<typeof Response>(Response, { schemaOptions });
